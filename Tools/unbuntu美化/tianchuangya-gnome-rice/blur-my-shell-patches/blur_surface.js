...
export const PopupBlurSurface = class PopupBlurSurface {
    ...
    create_actor() {
        ...
        // GNOME 46 的动态模糊层是矩形，叠加 corner 效果使其与 CSS 圆角对齐
        this.dynamic_corner = new DynamicCornerRounded(
            this.effects_manager,
            this.blur_actor,
    ...
    destroy_dynamic_actor() {
        ...
        if (this.dynamic_corner) {
            try { this.dynamic_corner.destroy(); } catch (e) { }
            this.dynamic_corner = null;
        }
        this.pipeline = null;
